...
local KICK_MESSAGE = "BLOCKED by OWNER ! Contract: @zings_009 (Teligram)";
...
local Window = Rayfield:CreateWindow({Name="Squid Game X by Free Guy",LoadingTitle="Loading Ultimate...",LoadingSubtitle="FREEDOM X FREE GUY ",ConfigurationSaving={Enabled=true,FolderName="SquidGameX",FileName="Config"}});
...
game.StarterGui:SetCore("SendNotification", {Title="Squid Game X FREE GUY !",Text="FREEDOM MATTERS :) |   Teligram @zings_009",Duration=6});
